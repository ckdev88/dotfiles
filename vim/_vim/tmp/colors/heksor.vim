...
# Name: Heksor
# Description: Oldschool limey theme.
# Last Updated: 2024-10-13 13:37


g:colors_name = 'heksor'
...
hi link tsxRegion Normal
hi Normal ctermfg=10 ctermbg=232 cterm=NONE guifg=#00ff00 guibg=#080808 gui=NONE
...
hi Conditional ctermfg=15 ctermbg=NONE cterm=NONE guifg=#ffffff guibg=NONE gui=NONE cterm=NONE
...
hi CursorColumn ctermbg=234 guibg=#0c0c1c
...
hi Function ctermfg=6 ctermbg=NONE cterm=NONE guifg=#008080 guibg=NONE gui=NONE
hi Ignore ctermfg=NONE ctermbg=NONE cterm=NONE guifg=fg guibg=NONE gui=NONE
hi IncSearch ctermfg=11 ctermbg=0 cterm=reverse guifg=#ffff00 guibg=#000000 gui=reverse

hi! link vimFuncKey Keyword
hi! link typescriptTry Keyword
hi! link vimCommand Keyword
hi! link vimhi Keyword
hi! link phpStatement Keyword 
hi! link typescriptConsoleMethod Keyword
hi Keyword ctermfg=15 ctermbg=NONE cterm=NONE guifg=#ffffff guibg=NONE gui=NONE cterm=NONE
...
hi! link typescriptGlobalConsoleDot	LineNr
...
hi Search ctermfg=16 ctermbg=11 cterm=NONE guifg=#000000 guibg=#ffff00 gui=NONE
...
hi StatusLine 	ctermfg=fg ctermbg=0 cterm=reverse guifg=fg guibg=#000000 gui=reverse
...
hi String ctermfg=10 ctermbg=NONE cterm=NONE guifg=#00ff00 guibg=NONE gui=NONE
...
hi! link Todo2 Todo
hi! link Todo3 Todo
hi Todo ctermfg=11 ctermbg=238 cterm=bold guifg=#ffff00 guibg=#444444 gui=bold
...
hi Type ctermfg=6 ctermbg=NONE cterm=NONE guifg=#008080 guibg=NONE gui=NONE
...
hi Visual ctermfg=16 ctermbg=10 cterm=NONE guifg=#000000 guibg=#00ff00 gui=NONE
...
hi typescriptObjectLiteral ctermfg=10 ctermbg=none cterm=none guifg=#00ff00 guibg=NONE gui=none
hi typescriptObjectLabel ctermfg=10 ctermbg=none cterm=none guifg=#00ff00 guibg=NONE gui=none
hi typescriptPaymentShippingOptionProp ctermfg=10 ctermbg=none cterm=none guifg=#00ff00 guibg=NONE gui=none
...
hi tsxTag ctermfg=15 guifg=#ffffff
hi tsxIntrinsicTagName ctermfg=15 guifg=#ffffff
hi tsxCloseTag ctermfg=15 guifg=#ffffff
hi typescriptAssign ctermfg=15 guifg=#ffffff
hi typescriptObjectColon ctermfg=15 guifg=#ffffff
hi tsxEqual ctermfg=15 guifg=#ffffff
