...
static const char *fonts[]          = { "Iosevka:style=Regular:size=12:antialias=true" };
static const char dmenufont[]       = "Iosevka:style=Regular:size=12:antialias=true"; 
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray2, "-nf", col_tan, "-sb", col_black, "-sf", col_tan, NULL };
