...
# 
# for kde on arch:
# - put this file the folder /etc/profile.d/ with chmod 755
# - have a folder ~/.konsole
# - add Application to startup, with arguments: --tabs-from-file '~/.konsole/current-tabs' -e 'bash -c exit&'
